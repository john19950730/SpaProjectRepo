...
public:
	...
	static vector<int> getAllFollowedStmts(string synonym1, bool star); // Follows(a, _)
	static vector<int> getAllStmtsFollowedBy(string synonym1, unsigned int stmtNo2, bool star); // Follows(a, 2)
	static vector<int> getAllFollowsStmts(string synonym2, bool star); // Follows(_, b)
	static vector<int> getAllStmtsThatFollows(unsigned int stmtNo1, string synonym2, bool star); // Follows(1, b)
	...
	static vector<int> getAllStmtsThatIsParentOf(string synonym1, unsigned int stmtNo2, bool star); // Parent(a, 2)
	static vector<int> getAllChildStmts(string synonym2, bool star); // Parent(_, b)
	static vector<int> getAllStmtsThatIsChildOf(unsigned int stmtNo1, string synonym2, bool star); // Parent(1, b)
