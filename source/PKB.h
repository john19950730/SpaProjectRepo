...
public:
	...
	static bool hasMoreThanOneLine(bool star); // Follows(_, _)
	static vector<pair<int, int> > getAllFollowsPair(string synonym1, string synonym2, bool star); // Follows(a, b)
	static vector<int> getAllStmtsWithFollows(string synonym1, bool star); // Follows(a, _)
	static vector<int> getAllStmtsFollowedByLine(string synonym1, unsigned int stmtNo2, bool star); // Follows(a, 2)
	static vector<int> getAllStmtsWithFollowedBy(string synonym2, bool star); // Follows(_, b)
	static vector<int> getAllStmtsFollowsLine(unsigned int stmtNo1, string synonym2, bool star); // Follows(1, b)
	...
	static bool hasNesting(bool star); // Parent(_, _)
	static vector<pair<int, int> > getAllParentPair(string synonym1, string synonym2, bool star); // Parent(a, b)
	static vector<int> getAllParentStmts(string synonym1, bool star); // Parent(a, _)
	static vector<int> getAllParentStmtsOfLine(string synonym1, unsigned int stmtNo2, bool star); // Parent(a, 2)
	static vector<int> getAllChildStmts(string synonym2, bool star); // Parent(_, b)
	static vector<int> getAllChildStmtsOfLine(unsigned int stmtNo1, string synonym2, bool star); // Parent(1, b)
