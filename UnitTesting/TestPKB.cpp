...
namespace UnitTesting
{
	...
	public:
		...
		TEST_METHOD(Parent)
		{
			...
			vector<unsigned int> lists6 = PKB::getAllStmtsThatIsParentOf("stmt", 6, true);
			Assert::IsTrue(lists6[0] == 5 && lists6[0] == 3);
			Assert::AreEqual(lists6.size(), (size_t)2);
			...
			Assert::IsTrue(list1a[0] == 6 && list1a[1] == 7);
		}
		TEST_METHOD(Uses)
		{
